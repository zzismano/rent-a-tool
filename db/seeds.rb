...
Review.create(content: "This lawn mower cut every single blade of grass in my garden.", rating: 5, tool: lawnmower, user: user_3)
...
Review.create(content: "Cutting the grass in my field with this lawnmower evoked beautiful smells of grass, dirt and petrichor", rating: 5, tool: lawnmower, user: user_2)
