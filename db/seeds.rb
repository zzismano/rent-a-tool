...
Tool.create(name: "perceuse", user: user, category: Category.first, description: "i dont know, its french")
Tool.create(name: "hammer", user: user, category: Category.first, description: "also good for murders")
Tool.create(name: "span", user: user, category: Category.first, description: "twisty-twist jigmagig")
